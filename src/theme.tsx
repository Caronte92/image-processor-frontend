...
export type LinkColors = {
  ghost: LinkColorState;
  primary: LinkColorState;
};
...
export const getLinkColors = (
  ...
  return {
    ...
    primary: {
      ...
      active: {
        content: palette.accentForeground,
        underline: palette.accent,
      },
      disabled: {
        content: palette.mutedForeground,
...
export interface IActiveTheme
  extends Omit<ITheme, 'colors' | 'buttonColors' | 'linkColors'> {
  // widthPage: string;
  mode: 'light' | 'dark';
  colors: MainColors;
  buttonColors: ButtonColors;
...
export const theme: ITheme = {
  ...
  linkColors: getLinkColors('light', { darkTheme, lightTheme }),
  icons: {
    xs: '1rem',
    sm: '1.25rem',
    md: '1.5rem',
...
export const createDynamicTheme = (mode: 'light' | 'dark'): IActiveTheme => {
  ...
  return {
    ...
    linkColors: getLinkColors(mode, theme.colors),
    icons: theme.icons,
  };
};
